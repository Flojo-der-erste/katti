...
class TestStringMethods(unittest.TestCase):
    ...
    def _text_experiment_only_chrome_1_vm(self):
    ...
    def _text_experiment_only_chrome_2_vm(self):
        browser_config = BrowserConfig.save_to_db(
            config=BrowserConfig.Config(browser_options=ChromeOptions()))
    ...
    def _text_experiment_only_chrome_3_vm(self):
        browser_config = BrowserConfig.save_to_db(
            config=BrowserConfig.Config(browser_options=ChromeOptions()))
    ...
    def _text_experiment_only_chrome_edge_1_vm(self):
        browser_config = BrowserConfig.save_to_db(
            config=BrowserConfig.Config(browser_options=ChromeOptions()))
    ...
    def _text_experiment_only_chrome_edge_2_vm(self):
        browser_config = BrowserConfig.save_to_db(
            config=BrowserConfig.Config(browser_options=ChromeOptions()))
        browser_config_2 = BrowserConfig.save_to_db(config=BrowserConfig.Config(browser_options=EdgeOptions()))
        browser_group = BrowserGroup()
    ...
    def _text_experiment_only_chrome_edge_3_vm(self):
        browser_config = BrowserConfig.save_to_db(
            config=BrowserConfig.Config(browser_options=ChromeOptions()))
        browser_config_2 = BrowserConfig.save_to_db(config=BrowserConfig.Config(browser_options=EdgeOptions()))
        browser_group = BrowserGroup()
    ...
    def _text_experiment_chrome_edge_firefox_1_vm(self):
    ...
    def _text_experiment_chrome_edge_firefox_2_vm(self):
        browser_config = BrowserConfig.save_to_db(config=BrowserConfig.Config(browser_options=ChromeOptions()))
        browser_config_2 = BrowserConfig.save_to_db(config=BrowserConfig.Config(browser_options=EdgeOptions()))
        browser_config_3 = BrowserConfig.save_to_db(config=BrowserConfig.Config(browser_options=FirefoxOptions()))
        browser_group = BrowserGroup()
    ...
    def _text_experiment_chrome_edge_firefox_3_vm(self):
        browser_config = BrowserConfig.save_to_db(config=BrowserConfig.Config(browser_options=ChromeOptions()))
        browser_config_2 = BrowserConfig.save_to_db(config=BrowserConfig.Config(browser_options=EdgeOptions()))
        browser_config_3 = BrowserConfig.save_to_db(config=BrowserConfig.Config(browser_options=FirefoxOptions()))
        browser_group = BrowserGroup()
