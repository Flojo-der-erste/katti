...
** Disclaimer
This is the prototype of the crawling engine. The prototype is part of our demo paper for Webconf 2023. We are working on the release of Katti v0.2, including a number of improvements to the crawling engine and the scanner engine. Soon you will be able to find the project at the following link.
